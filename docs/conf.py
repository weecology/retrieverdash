...
copyright = '2018, Ethan White, Henry Senyondo, Apoorva Pandey'
author = 'Ethan White, Henry Senyondo, Apoorva Pandey'
...
htmlhelp_basename = 'DataRetrieverDashboarddoc'
...
latex_documents = [
    (master_doc, 'DataRetrieverDashboard.tex', 'Data Retriever Dashboard Documentation',
     'Ethan White, Henry Senyondo, Apoorva Pandey', 'manual'),
]
