...
# The DEV_IGNORE_LIST from issue #45 here useful for testing on less strong machines.
...
# CHECK_DATASETS = ['harvard-forest', 'iris']
...
def check_dataset(dataset):
    ...
    try:
        ...
        if dataset_type(dataset) == 'spatial':
            ...
            if dataset.name not in dataset_detail or md5 != dataset_detail[dataset.name]['md5']:
